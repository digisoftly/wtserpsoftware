...
import { ShieldCheck, Loader2, ArrowRight, Building2, Lock, Mail, Languages, Info, AlertCircle, Sparkles } from 'lucide-react';
 ...
 * Optimized for all devices and pre-filled with demo credentials.
 */
export default function LoginPage() {
  ...
  return (
    <div className="min-h-svh flex flex-col lg:flex-row items-stretch bg-slate-50 overflow-y-auto">
      {/* LEFT PANE: BRANDING & ILLUSTRATION (Desktop Only) */}
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-4 md:p-12 min-h-svh relative">
        {/* Language Toggle - Absolute positioned but accessible */}
        ...
        <div className="w-full max-w-md space-y-8 relative">
          <div className="bg-white p-8 md:p-12 rounded-[2.5rem] shadow-2xl shadow-slate-200 border border-slate-100 animate-in fade-in zoom-in-95 duration-500 overflow-hidden relative">
            ...
            {isRedirecting ? (
              <div className="flex flex-col items-center justify-center py-12 space-y-4">
                ...
                <p className="text-sm font-bold text-blue-600 animate-pulse uppercase tracking-widest">Establishing Session...</p>
              </div>
            ) : (
              <form onSubmit={handleEmailLogin} className="space-y-6">
                ...
                <div className="relative py-2">
                  ...
                  <div className="relative flex justify-center text-[10px] uppercase font-bold tracking-[0.2em]">
                    <span className="bg-white px-4 text-slate-400">Security Terminal</span>
                  </div>
                </div>
          ...
          {/* Quick Credential Tip for Prototype */}
          <div className="bg-blue-50/50 p-4 rounded-2xl border border-blue-100 flex items-center gap-3">
            ...
            <p className="text-[10px] font-bold text-blue-700 uppercase tracking-tight">
              PROTOTYPE ACCESS: Use <span className="underline">{email}</span> / <span className="underline">{password}</span>
            </p>
          </div>
          ...
          <footer className="text-center pb-4">
            <p className="text-[10px] text-slate-400 font-bold uppercase tracking-widest leading-relaxed">
              ...
              Enterprise Resource Planning CMS
            </p>
          </footer>
        </div>
      </div>
