...
export function WarriorLayout({
  ...
  const renderCompanyName = () => {
    return (
      <h1 className="text-[36px] font-black tracking-tighter flex items-center justify-center leading-none">
  ...
  return (
    <div className="flex flex-col min-h-full bg-white text-[#222222] font-sans p-0 select-none border border-slate-100">
      {/* HEADER SECTION - PIXEL PERFECT REPLICA */}
      <div className="relative text-center space-y-1 mb-2 px-6 pt-4">
        ...
        <p className="text-[11px] font-bold text-[#F57C00] uppercase tracking-[0.2em] italic leading-none">
        ...
        {/* Red Dashed Line Divider */}
        <div className="border-t-[1px] border-red-500 border-dashed w-full pt-1 mt-3" />
      </div>
      ...
      {/* CUSTOMER & DOCUMENT INFO GRID - COLON ALIGNED */}
      <div className="grid grid-cols-2 gap-12 mb-6 px-8">
        <div className="space-y-1">
          <h3 className="text-xs font-black uppercase mb-2 border-b border-black w-fit pr-4">Customer Info</h3>
      ...
      <div className="px-4">
        <div className="bg-[#FDEBD0] border border-black p-1.5 text-center">
          <h3 className="text-[16px] font-black text-[#0056B3] uppercase underline underline-offset-4 tracking-tight">
          ...
          <tbody>
            ...
            <tr className="border-t border-black">
               <td colSpan={3} rowSpan={6} className="p-4 align-top border border-black relative bg-white">
                  ...
                  <p className="text-[10px] font-bold italic text-slate-500 mt-4 capitalize">--- Only</p>
               </td>
            ...
            <tr className="bg-[#FEF9E7]">
               <td colSpan={6} className="border border-black p-1 text-center text-[9px] font-bold italic">
      ...
      {/* SIGNATURES SECTION - FOUR COLUMNS */}
      ...
      {/* CORPORATE FOOTER */}
      <div className="mt-auto pt-4 pb-6 text-center space-y-2 border-t border-[#00D4AA] border-dotted mx-4">
