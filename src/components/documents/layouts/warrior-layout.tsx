...
export function WarriorLayout({
  ...
  return (
    <div className="flex flex-col min-h-full bg-white text-[#222222] font-sans p-0 print:p-0 select-none">
      {/* HEADER SECTION - PIXEL PERFECT REPLICA */}
      <div className="text-center space-y-1 mb-2">
        <div className="flex items-center justify-center gap-3 mb-1">
          ...
          <h1 className="text-[44px] font-black tracking-tighter flex items-center justify-center leading-none">
        ...
        <div className="flex justify-center items-center gap-4 text-[10px] font-bold text-[#555555] mt-1">
          <span className="flex items-center gap-1.5">📞 +8801753646372</span>
          <span className="flex items-center gap-1.5">📧 warriortechsystem.com</span>
          <span className="flex items-center gap-1.5">🌐 www.warriortechsystem.com</span>
        </div>
        <p className="text-[10px] font-bold text-[#555555] flex items-center justify-center gap-1.5">
          📍 GP.Ja-66/2, Gojnabi Rd, Wireless Gate, Mohakhali, Gulshan, Dhaka-1212.
        </p>
        <div className="border-t border-red-800/30 border-dashed w-full pt-1 mt-2" />
      </div>

      {/* DYNAMIC TITLE */}
      <div className="text-center my-5">
        <h2 className="text-2xl font-black uppercase underline underline-offset-[6px] decoration-1">
          {title || "Price List/Quotation"}
        </h2>
      </div>

      {/* CUSTOMER & DOCUMENT INFO GRID */}
      <div className="grid grid-cols-2 gap-16 mb-8 px-4">
        <div className="space-y-1.5">
          <h3 className="text-sm font-black uppercase mb-1">Customer Info</h3>
          <div className="grid grid-cols-[80px_15px_1fr] text-[11px] leading-tight gap-y-1">
        ...
        <div className="space-y-1.5 pt-6">
          <div className="grid grid-cols-[110px_15px_1fr] text-[11px] leading-tight gap-y-1">
            <span className="font-bold">Invoice No</span> <span>:</span> <span className="font-black text-blue-800">{docNumber}</span>
            ...
            <span className="font-bold">Status</span> <span>:</span> <span className="font-black text-green-700">{status || 'Paid'}</span>
          </div>
        </div>
      </div>
      ...
      <div className="bg-[#FDEBD0] border border-black p-2 text-center">
        <h3 className="text-[17px] font-black text-[#0056B3] uppercase underline underline-offset-4 tracking-tighter">
          IMPLEMENTATION AND COST SUMMARY
        </h3>
      </div>
      <div className="bg-[#D5F5E3] border-x border-black p-1 text-center">
        <p className="text-[10px] font-black uppercase tracking-[0.2em] text-[#155724]">
          BUDGETED PROPOSAL ON NETWORK SOLUTION AND CCTV.
        </p>
      </div>

      {/* MAIN DATA TABLE - Orange Header / Black Borders */}
        ...
        <table className="w-full border-collapse border border-black table-fixed">
          <thead>
            <tr className="bg-[#F57C00] text-white">
              ...
              <th className="border border-black w-28 py-2 text-right text-[10px] font-black uppercase px-2">Unite Price</th>
          ...
          <tbody>
            ...
            {/* COMPACT SUMMARY ROWS INTEGRATED INTO TABLE */}
            <tr className="border-t border-black">
               <td colSpan={3} rowSpan={6} className="p-4 align-top border border-black relative">
                  ...
                  <p className="text-[10px] font-bold italic text-slate-500 mt-3">--- Only</p>
               </td>
            ...
            <tr>
               ...
               <td className="border border-black p-1.5 text-right text-[13px] font-black pr-4 text-[#0056B3]">{grandTotal.toLocaleString()}</td>
            </tr>
            <tr>
            ...
            <tr className="bg-[#FEF9E7]">
               <td colSpan={6} className="border border-black p-1 text-center text-[10px] font-bold italic underline decoration-1">
      ...
      {/* PROJECT DETAILS BOX */}
      <div className="mt-4 border border-black p-3 space-y-1 bg-white">
        <div className="grid grid-cols-[160px_20px_1fr] text-[11px] leading-tight">
          ...
          <span className="font-bold">Quotation Reference</span> <span>:</span> <span className="font-medium">WTS-QT-2026-0015</span>
          <span className="font-bold">Delivery Challan</span> <span>:</span> <span className="font-medium">WTS-DC-2026-0012</span>
          <span className="font-bold">Service Warranty</span> <span>:</span> <span className="font-bold text-blue-700">12 Months</span>
          <span className="font-bold">Project Manager</span> <span>:</span> <span className="text-slate-400">---</span>
        </div>
      </div>
        ...
        <div className="grid grid-cols-4 gap-8 items-end text-center">
          ...
          <div className="space-y-2 relative">
            <div className="absolute -top-16 left-1/2 -translate-x-1/2 opacity-25 pointer-events-none">
              <div className="w-20 h-12 border-2 border-slate-500 flex items-center justify-center text-[8px] font-black rotate-[15deg] uppercase">Proprietor</div>
            </div>
      ...
      <div className="mt-auto pt-6 pb-4 text-center space-y-2 border-t border-[#00D4AA] border-dotted mx-2">
        <p className="text-[10px] font-black text-slate-400 flex items-center justify-center gap-2">
          ❤ Thank You for Your Business ❤
        </p>
        <h4 className="text-sm font-black text-slate-900 uppercase tracking-tight leading-none">Warrior Tech System</h4>
        <p className="text-[9px] font-bold text-slate-400 uppercase tracking-[0.4em]">Innovative Security, Reliable Communication</p>
        <div className="flex justify-center items-center gap-4 text-[8px] font-black text-[#0056B3] uppercase tracking-widest mt-1">
           <span className="flex items-center gap-1.5"><span className="text-[#F57C00] text-[10px]">•</span> Security System</span>
           <span className="flex items-center gap-1.5"><span className="text-[#F57C00] text-[10px]">•</span> Communication System</span>
           <span className="flex items-center gap-1.5"><span className="text-[#F57C00] text-[10px]">•</span> Fire Safety</span>
           <span className="flex items-center gap-1.5"><span className="text-[#F57C00] text-[10px]">•</span> Network & IT Solutions</span>
        </div>
      </div>
