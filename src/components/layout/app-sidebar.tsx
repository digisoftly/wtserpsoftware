...
const MODULES = [
  ...
  { name: "dispatch", key: "dispatch", icon: Truck, path: "/challans", color: "text-cyan-400" },
  ...
  { name: "masterManagement", key: "masterManagement", icon: Database, path: "/master/units", color: "text-orange-400" },
